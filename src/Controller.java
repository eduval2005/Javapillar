...
public class Controller extends JPanel {
    ...
    public Controller() {
        ...
        try {
            AudioInputStream audioInputStream = AudioSystem
                    .getAudioInputStream(new File("assets/crunch.wav").getAbsoluteFile());
    ...
    public void resetCaterpillar() {
        ...
        kate = new Caterpillar(startX, startY, segDistance, segCount, initBearing); // x, y, segDistance, segCount,
                                                                                    // bearing
    ...
    public void gameOver() {
        ...
        startagainButton.setBounds(250, 300, 100, 50);
